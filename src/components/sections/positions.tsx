...
const positionData: LocationGroup[] = [
  {
    ...
    positions: [
      ...
      {
        company: '北京眸視科技有限公司',
        role: '稍實習演算法工程師(大模型、3D視覺感知方向)',
        duties: ['負責空間智慧相關演算法研發，包括但不限於：三維視覺感知、深度估計、SLAM、三維重建、空間場景理解與定位導航、VLA/VLN、空間物體識別與AIGC等',
          '結合業務需求（如機器人導航、工業巡檢和製造、AR/VR等），面向工業智慧化場景落地設計高效的空間計算模型與演算法',
          '優化演算法性能，提升系統在複雜場景下的魯棒性與高效性',
          '跟進前沿技術（如3DGS、多感測器融合、端到端空間場景和物體生成建模、具身智慧VLA/VLN等），推動技術落地'],
        requirements: ['電腦科學、人工智慧、機器人學、自動化、控制科學、測繪遙感、數學等相關專業碩士及以上學歷',
          '扎實的空間計算基礎，熟悉3D幾何、多視圖幾何、點雲處理、電腦視覺等理論與演算法',
          '精通至少一種主流深度學習框架（PyTorch/TensorFlow），熟練使用C++/Python程式設計',
          '具備SLAM、三維重建、多感測器標定與融合等領域的相關知識儲備',
          '較強的論文複現能力或演算法創新能力，能快速實現並優化前沿技術方案',
          '良好的團隊協作與溝通能力，對技術落地有強烈熱情']
      },
...

      {
        company: '友為',
        role: '軟體測試實習生',
        duties: ['進行需求分析與評審，發現設計問題',
          '編寫測試計畫&測試用例，發現產品問題',
          '持續跟進解決產品發佈過程中的品質問題',
          '參與產品上線後的品質維護和改進工作',
          '參與優化並維護現有的用例和測試流程'
        ],
        requirements: ['2026年7月份前畢業的學生優先']
      },

      {
        company: '友為',
        role: '產品實習生',
        duties: ['負責用友各業務領域產品的功能規劃、分析、研發與業務推進等工作',
          '根據公司戰略及業務發展規劃，瞭解行業發展趨勢，掌握競爭對手的最新情況，結合新技術積極創新',
          '收集和研究不同企業的需求，總結提煉，並根據規劃方向落實到具體應用模型，結合公司平臺優勢資源，打造高價值的產品'
        ],
        requirements: ['2026年7月份前畢業的學生優先']
      },
      ...
      {
        company: '智譜華章',
        role: '智譜AI-國際業務中心AI應用工程師實習生',
        duties: ['系統性的掌握大模型、Python、提示詞工程、微調的相關原理和技術',
          '參與客戶售前和交付階段大模型PoC方案設計、選型和具體實現，負責客戶溝通，深入挖掘業務場景需求',
          '參與大模型應用領域相關產品技術方案的研究和創新，競品的調研和分析，支持業務的快速反覆運算'           
        ],
        requirements: ['本科及以上學歷，電腦、通信、人工智慧等相關專業，有大模型專案應用落地經驗者優先',
          '瞭解機器學習、深度學習演算法的基礎原理和優化流程',
          '良好的邏輯思維，優秀的語言表達能力',
          '瞭解AI的前沿應用，有較強的業務模型分析能力、溝通能力和文檔編寫能力']
      },

      {
        company: '智譜華章',
        role: '智譜AI-國際業務中心業務拓展實習生',
        duties: ['協助銷售團隊完成銷售目標，為客戶提供優質服務',
          '跟進潛在客戶，瞭解客戶需求，挖掘客戶潛力',
          '負責銷售資料的收集、整理和分析',
          '參與市場調研，瞭解行業動態及競爭對手資訊',
          '協助完成銷售團隊的日常事務性工作'       
        ],
        requirements: ['本科及以上學歷，市場行銷、商務管理等相關專業優先',
          '具有良好的溝通能力、團隊協作精神和客戶服務意識',
          '熟練使用辦公軟體，具備一定的資料分析能力',
          '工作認真負責，具有較強的學習能力和執行力',
          '實習期至少3個月，每週工作時間不少於4天'
        ]
      },

      {
        company: '中關村科學城',
        role: '國際合作實習生',
        duties: ['協助負責人進行優秀國際化科技企業及國際創新合作資源調研, 共同討論思考對外合作以及提供服務內容的可能性，並與其建立長期合作關係，能獨立操作以上流程者優先錄取',
          '協助負責人開展國際產業以及京港科技支援政策研究工作，使用中英語言展開國際創新動態及創新案例的研究',
          '協助進行中關村科學城-香港創新加速器運營、國際氛圍營造等活動的組織，實地參與活動的執行',
          '協助領導安排的其它工作'
        ],
        requirements: ['國內外優秀高校本科或研究生, 實習週期至少3個月，可實習3-6個月優先',
          '要求中英語言流利，有海外學習經驗優先',
          '具有較強的資訊搜集調研能力，能用中英語言搜索國內外企業或機構資訊動向',
          '對國際大企業、國際合作以及各類行業新知識、新動態感興趣並願意去發掘和思考',
          '獨立思考能力強，有主動創新的思維',
          '樂於參加線上和線下的各類活動，具有一定活動的執行能力者優先錄取'
        ]
      },

      {
        company: '中關村科學城',
        role: '資訊研究實習生(英語方向)',
        duties: ['圍繞阿聯酋及其它國家創新創業，開放創新等領域，輔助動收集匯總相關新聞、趨勢及投資動態',
          '圍繞阿聯酋及其它國家前沿科技方向，整理企業發展情況，梳理產業鏈關係',
          '圍繞企業創新戰略整理企業戰略佈局相關資訊及產業案例',
          '圍繞前沿科技，開展國內外產業培育政策、典型培育模式、產業發展動態資訊收集及整理'
        ],
        requirements: ['能將英文作為工作語言',
          '要求中英語言流利，有海外學習經驗優先',
          '文案能力強，善於使用英文閱讀文獻，報刊雜誌等，並能從中提煉關鍵資訊，整理為中英文報告形式',
          '對於創新創業，前沿科技動態有積累優先',
          '自我驅動力和學習能力強，思維嚴謹；邏輯清晰，具備挖掘分析問題的能力',
          '認真細心，能刻苦鑽研，對所接到的研究任務精益求精'
        ]
      },
  ...
  },
  {
    ...
    },
    {
      ...
      role: 'UI/UX設計師',      
      requirements: ['修讀computer science ，database ，electronic engineering，AI. design 相關課程',]
    },
